...
locals:
	...
	defaultQualifierKey : string;		-- Default Qualifier Code key
...
--
	  ...
	  -- If launched from the Marker Module...
	  if (markerModule != nil and ab.is_defined("annotTypeKey") != nil) then
...
--
	...
	Modify does
	  ...
	  PythonMarkerCVCache.objectKey := currentRecordKey;
...
--
	...
	PrepareSearch does
	  ...
	  -- Marker Types
		 ...
		 top->MarkerTypeMenu.menuHistory.searchValue;
	    from_marker := true;
          end if;

...
print ""
print "Homology - Rat vs. Mouse (Sorted by Rat Chromosome)"
print ""

select distinct 
m1.chromosome + m1.cytogeneticOffset "Rat-Chr", 
m1.symbol "Rat-Symbol",
...
order by c.sequenceNum, m1.cytogeneticOffset
go
